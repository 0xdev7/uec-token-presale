...
contract PresaleBEP20 is Ownable {
    ...
    uint256 public hardCapEthAmount = 9600 ether;
    ...
    constructor(
        ...
        presaleEndTimestamp = now.add(25 days + 1 hours + 30 minutes);
    }
    ...
    function deposit() public payable {
        ...
        rewardTokenCount = 0.0008 ether; //  1250 tokens per BNB
     ...
     function setWithdrawAddress(address payable _address) external {
