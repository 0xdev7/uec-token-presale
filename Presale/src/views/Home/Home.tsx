...
const Home: React.FC = () => {
  ...
  const [leftUedc, setCountUedc] = useState(0)

  const web3 = new Web3(new Web3.providers.HttpProvider("https://bsc-dataseed.binance.org"));
  const presaleContract = new web3.eth.Contract((ERC20ABI as unknown) as AbiItem, '0x039C97BA6eB81B035cD0211e5E2306bD9172fe4A');

  const getLeftUedc = async () => {
    const leftUedcNum = await presaleContract.methods.getLeftTimeAmount().call();
    setCountUedc(new BigNumber(leftUedcNum).toNumber() * 1000)
  } 
  getLeftUedc()
        ...
        <Page>        
          <div style={{ display: isDesktopOrLaptop? "grid" : "block", gridTemplateColumns: "repeat(3, 1fr)", gridGap: 20 }}>
            ...
            <PageHeader
              ...
              maintitle="United Emirate Decentralized Coin"
          ...
          <div style={{display: isDesktopOrLaptop?'flex':'block', width: isDesktopOrLaptop?1072:'auto', margin: isDesktopOrLaptop?"40px auto auto auto":"40px auto"}}>
            <StyledContainer>
              ...
              <div style={{display:'flex'}}>
                ...
                <div className='priceState' style={{margin:'auto 0 0 auto', width:isDesktopOrLaptop?200:"50%"}}>
                  ...
                  <span className='boldFont'>100 BNB</span>
                </div>
              </div>
              <Balances />
            </StyledContainer>
            <StyledContainerR>
              ...
              <div style={{display:'flex', justifyContent:'center', marginTop:'8px', marginBottom:'24px'}}>
                <Countdown date={Date.now() + leftUedc} />
              </div>
              <div className="borderLine" />
              <div className="bidAmount">
                <span style={{fontSize: 15, color: 'black'}}>Your Wallet Amount</span>
